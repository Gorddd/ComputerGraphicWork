...
ObjFile objModel, monkey, myHome, ball;
Texture monkeyTex, mainTexture, secondTexture, currentTexture;
...
void keyDownEvent(OpenGL *ogl, int key)
{
	...
	if (key == 'W') {
		currentTexture = isMain ? secondTexture : mainTexture;
		isMain = isMain ? false : true;
	}
...
void initRender(OpenGL *ogl)
{
	...
	*/
	...
	loadModel("models\\untitled.obj", &myHome);
	mainTexture.loadTextureFromFile("models\\main.bmp");
	secondTexture.loadTextureFromFile("models\\second.bmp");
	isMain = true;
	currentTexture = mainTexture;
	currentTexture.bindTexture();

	loadModel("models\\beachball.obj", &ball);
